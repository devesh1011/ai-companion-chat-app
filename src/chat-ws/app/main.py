...
from app.db import get_db, ChatSession, SessionStatus, Message
from app.websocket_conn import manager
from app.core import get_settings
from app.ipc.validate_token import validate_token
            ...
            while True:
                try:
                    ...
                    if message and message.get("type") == "message":
                        ...
                        response_payload = {"type": "ai_response", "data": data}
                        print(f"Sending to WebSocket: {response_payload}", flush=True)
                        await websocket.send_json(response_payload)
                        print("Sent AI response to client", flush=True)
        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    # Echo the message back to the client for immediate display
                    ...
                    print("Echo sent to client", flush=True)
                except Exception as e:
